...
from products.models import SubCategoryChild
...
def category_slider_upload(instance, filename):
    return "images/marketing/categoty_slider/%s" % (filename)


def all_category_slider_upload(instance, filename):
    return "images/marketing/all_categoty_slider/%s" % (filename)
...
class AllCategorySlider(models.Model):
    image = models.ImageField(upload_to=all_category_slider_upload)
    order = models.IntegerField(default=0)
    url_link = models.CharField(max_length=250, null=True, blank=True)
    header_text = models.CharField(max_length=120, null=True, blank=True)
    text = models.CharField(max_length=120, null=True, blank=True)
...
class CategorySlider(models.Model):
    sub_cat_child = models.ForeignKey(SubCategoryChild, null=True, blank=True)
    image = models.ImageField(upload_to=category_slider_upload)
    order = models.IntegerField(default=0)
    url_link = models.CharField(max_length=250, null=True, blank=True)
    header_text = models.CharField(max_length=120, null=True, blank=True)
    text = models.CharField(max_length=120, null=True, blank=True)
